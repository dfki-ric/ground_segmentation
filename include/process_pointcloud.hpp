...
public:
    ...
    std::pair< typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr>  SegmentPlane_RANSAC(typename pcl::PointCloud<PointT>::Ptr cloud, 
										 int maxIterations, 
										 float distanceThreshold);
    ...
    std::vector< typename pcl::PointCloud<PointT>::Ptr>  Clustering_euclideanCluster(typename pcl::PointCloud<PointT>::Ptr cloud, 
											float clusterTolerance, 
											int minSize, 
											int maxSize);

    std::vector<std::vector<int>> euclideanCluster(typename pcl::PointCloud<PointT>::Ptr cloud,  
	                                                 KdTree_euclidean<PointT>* tree, 
												   float distanceTol, 
												   int minSize, 
												   int maxSize);
    ...
    //constructor:
  template <typename PointT>
  ProcessPointCloud<PointT>::ProcessPointCloud() {}
  ...
  * */
  ...
  template <typename PointT>
  typename pcl::PointCloud<PointT>::Ptr ProcessPointCloud<PointT>::FilterCloud(typename pcl::PointCloud<PointT>::Ptr cloud, bool downSampleInputCloud, float filterRes, Eigen::Vector4f minPoint, Eigen::Vector4f maxPoint)
  {
  ...
  template <typename PointT>
  std::pair< typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr>  ProcessPointCloud<PointT>::SeparateClouds(pcl::PointIndices::Ptr inliers, typename pcl::PointCloud<PointT>::Ptr cloud)
  {
  ...
  template <typename PointT>
  std::pair< typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr>  ProcessPointCloud<PointT>::SegmentPlane(typename pcl::PointCloud<PointT>::Ptr cloud, int maxIterations, float distanceThreshold)
  {
      // Time segmentation process
      auto startTime = std::chrono::steady_clock::now();
  ...
  * */
  ...
  template <typename PointT>
  std::pair< typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr>  ProcessPointCloud<PointT>::SegmentPlane_RANSAC(typename pcl::PointCloud<PointT>::Ptr cloud, int maxIterations, float distanceThreshold)
  {
      // Time segmentation process
      auto startTime = std::chrono::steady_clock::now();
  ...
  template <typename PointT>
  std::vector< typename pcl::PointCloud<PointT>::Ptr>  ProcessPointCloud<PointT>::Clustering(typename pcl::PointCloud<PointT>::Ptr cloud, float clusterTolerance, int minSize, int maxSize)
  {
  ...
  * */
  ...
  template <typename PointT>
  void ProcessPointCloud<PointT>::Proximity(typename pcl::PointCloud<PointT>::Ptr cloud,std::vector<int> &cluster,std::vector<bool> &processed_f,int idx, KdTree_euclidean<PointT>* tree,float distanceTol, int maxSize)
  {
  ...
  * */
  ...
  template <typename PointT>
  std::vector<std::vector<int>> ProcessPointCloud<PointT>::euclideanCluster(typename pcl::PointCloud<PointT>::Ptr cloud,  KdTree_euclidean<PointT>* tree, float distanceTol, int minSize, int maxSize)
  {
  ...
  * */
  ...
  template <typename PointT>
  std::vector< typename pcl::PointCloud<PointT>::Ptr>  ProcessPointCloud<PointT>::Clustering_euclideanCluster(typename pcl::PointCloud<PointT>::Ptr cloud, float clusterTolerance, int minSize, int maxSize)
  {
  ...
  template <typename PointT>
  void ProcessPointCloud<PointT>::savePcd( typename pcl::PointCloud<PointT>::Ptr cloud, std::string file)
  {
      pcl::io::savePCDFileASCII (file, *cloud);
  }
  
  template <typename PointT>
  typename pcl::PointCloud<PointT>::Ptr ProcessPointCloud<PointT>::loadPcd(std::string file)
  {
