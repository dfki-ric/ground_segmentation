...
\end{DoxyCode}
\hypertarget{index_autotoc_md22}{}\doxysubsection{\texorpdfstring{Core Class}{Core Class}}\label{index_autotoc_md22}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md23}{}\doxysubsection{\texorpdfstring{Main API}{Main API}}\label{index_autotoc_md23}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md24}{}\doxysection{\texorpdfstring{Typical Configuration}{Typical Configuration}}\label{index_autotoc_md24}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md25}{}\doxysection{\texorpdfstring{Performance Summary (\+Semantic\+KITTI)}{Performance Summary (SemanticKITTI)}}\label{index_autotoc_md25}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md26}{}\doxysection{\texorpdfstring{Intended Use}{Intended Use}}\label{index_autotoc_md26}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md27}{}\doxysection{\texorpdfstring{Notes \& Future Work}{Notes \& Future Work}}\label{index_autotoc_md27}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{index_autotoc_md28}{}\doxysection{\texorpdfstring{Tests \& Visualisation}{Tests \& Visualisation}}\label{index_autotoc_md28}
...
The code uses {\bfseries{PCL}}, {\bfseries{Eigen}}, and {\bfseries{Google\+Test}} and is intended for quick validation of grid indexing, ground classification logic, and phase-\/based segmentation behaviour.\hypertarget{index_autotoc_md29}{}\doxysubsection{\texorpdfstring{Contents}{Contents}}\label{index_autotoc_md29}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{index_autotoc_md30}{}\doxysubsection{\texorpdfstring{Notes}{Notes}}\label{index_autotoc_md30}
...
BSD-\/3 Clause License.\hypertarget{index_autotoc_md32}{}\doxysection{\texorpdfstring{Citation}{Citation}}\label{index_autotoc_md32}
