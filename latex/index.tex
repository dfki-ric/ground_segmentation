...
This demo video uses the \href{https://www.semantic-kitti.org/index.html}{\texttt{ Semantic\+KITTI}} dataset for evaluation and visualization. \hypertarget{index_autotoc_md6}{}\doxysection{\texorpdfstring{ROS2}{ROS2}}\label{index_autotoc_md6}
...
GSeg3D performs {\bfseries{two-\/phase grid-\/based ground segmentation}}\+:\hypertarget{index_autotoc_md9}{}\doxysubsection{\texorpdfstring{Phase I – Coarse Segmentation}{Phase I – Coarse Segmentation}}\label{index_autotoc_md9}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md10}{}\doxysubsection{\texorpdfstring{Phase II – Refinement}{Phase II – Refinement}}\label{index_autotoc_md10}
...
This dual-\/phase strategy achieves a strong balance between {\bfseries{precision and recall}}, which is critical for safety-\/critical systems.\hypertarget{index_autotoc_md11}{}\doxysection{\texorpdfstring{Processing Pipeline}{Processing Pipeline}}\label{index_autotoc_md11}
...
\DoxyCodeLine{./test/test\_visual\_segmentation\ utah.ply\ 1.0\ 15\ -\/0.5}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md27}{}\doxysection{\texorpdfstring{Typical Configuration (from Paper)}{Typical Configuration (from Paper)}}\label{index_autotoc_md27}

\begin{DoxyCode}{0}
\DoxyCodeLine{cellSizeX:\ 1.5}
\DoxyCodeLine{cellSizeY:\ 1.0}
\DoxyCodeLine{cellSizeZ:\ 1.5\ \ \ \#\ Phase\ I}
\DoxyCodeLine{slopeThresholdDegrees:\ 30.0}
\DoxyCodeLine{groundInlierThreshold:\ 0.125}
\DoxyCodeLine{centroidSearchRadius:\ 5.0}
\DoxyCodeLine{distToGround:\ -\/1.723\ \#\ (e.g.\ Based\ on\ pointcloud\ data\ from\ SemanticKITTI)}
\DoxyCodeLine{robotRadius:\ 2.7}
