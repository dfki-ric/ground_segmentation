...
[master repository](https://git.hb.dfki.de/dfki-perception/ground_segmentation.git) on GitHub, then submit a "pull request"
(PR):

1. [Create an account](https://github.com/signup/free) on
   GitHub if you do not already have one.

2. Fork the [project repository](https://git.hb.dfki.de/dfki-perception/ground_segmentation.git):
